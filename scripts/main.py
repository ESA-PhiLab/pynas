...
from dataloader import SegmentationDataModule
from pynas.core.config import load_config
...
parser = argparse.ArgumentParser(
    description="Run the PyNAS genetic algorithm for neural architecture search."
)
parser.add_argument("--gen", type=int, default=None, help="Generation to load and start NAS.")
parser.add_argument(
    "--config", type=str, default=None, help="Path to a configuration override file."
)
parser.add_argument(
    "--data-root",
    type=str,
    default=str(cwd / "data" / "Phisat2Simulation"),
    help="Path to the segmentation dataset root.",
)
# Computation parameters
parser.add_argument("--seed", type=int, default=None, help="Random seed for reproducibility.")
# NAS parameters
parser.add_argument(
    "--max_layers", type=int, default=None, help="Maximum number of layers in the architecture."
)
parser.add_argument(
    "--max_parameters",
    type=int,
    default=None,
    help="Maximum number of parameters allowed in models.",
)
# GA parameters
parser.add_argument(
    "--max_iterations", type=int, default=None, help="Maximum number of generations."
)
...
parser.add_argument(
    ...
    type=float,
    default=None,
    help="Fraction of population to use for mating.",
)
parser.add_argument(
    "--mutation_probability", type=float, default=None, help="Probability of mutation."
)
parser.add_argument(
    "--epochs", type=int, default=None, help="Number of epochs for training each model."
)
parser.add_argument("--batch_size", type=int, default=None, help="Batch size for training.")
parser.add_argument(
    "--n_random", type=int, default=None, help="Number of random individuals per generation."
)
...
parser.add_argument(
    ...
    type=int,
    default=None,
    help="Number of individuals to train concurrently within each generation.",
)
...
def main(args):
    try:
        ...
        if args.training_workers is not None:
            config.set("GA", "training_workers", str(args.training_workers))
        ...
        training_workers = config.getint("GA", "training_workers", fallback=1)
        max_params = config.getint("GA", "max_parameters", fallback=100_000)
        ...
        config_path = Path(pop.save_directory) / "config.ini"
